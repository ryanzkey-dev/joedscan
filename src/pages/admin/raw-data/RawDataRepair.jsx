...
const STATUS_FILTER_OPTIONS = ['All', 'Pending', 'Dispatched', 'In Progress', 'Completed', 'Cancelled']
...
export default function RawDataRepair() {
  ...
  const loadAll = async () => {
    ...
    setError('')
    try {
      const res = await apiRequest('getRepairTickets')
  ...
  return (
    <div className="w-full max-w-full space-y-6 overflow-hidden">
      <h1 className="text-xl font-bold text-gray-800">Raw Data — Repair</h1>
      ...
      <div className="grid grid-cols-1 gap-3 rounded-xl bg-white p-4 shadow-sm sm:grid-cols-2 lg:grid-cols-3">
        <div className="relative lg:col-span-2">
          ...
          <input
            ...
            placeholder="Search by subscriber, mobile, address, issue, or technician"
